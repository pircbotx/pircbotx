 ...
 */
public class RemoveModerated {
	/**
	 * Simple listener that takes event parameters as parameters. See 
	 * {@link RemoveModerated} for an explanation on use 
	 * @see RemoveModerated 
	 */
	...
	/**
	 * Listener that receives an event. See {@link RemoveModerated} for an explanation 
	 ...
	 * information. See {@link RemoveModerated} for an explanation on when this is created
	 * <p>
